...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MOONBLAST, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MOONBLAST, THUNDER_WAVE
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, MOONBLAST
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, MOONBLAST, THUNDER_WAVE
	...
	db 35, MAGNETON,   THUNDERSHOCK, MOONBLAST, THUNDER_WAVE, SWIFT
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, MOONBLAST, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, MOONBLAST, ROLLOUT, LIGHT_SCREEN
	...
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, MOONBLAST, SUPERSONIC
...
Rival2Group:
	...
	db 41, MAGNETON,   THUNDERSHOCK, MOONBLAST, THUNDER_WAVE, SWIFT
	...
	db 45, MAGNETON,   THUNDER, MOONBLAST, THUNDER_WAVE, SWIFT
...
PsychicGroup:
	...
	db 13, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, PLAY_ROUGH, CONFUSION, NO_MOVE
	db -1 ; end
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, MOONBLAST, THUNDER, ROLLOUT
	db -1 ; end
